...
ProductPicture.create!(id: 7, name: "Inspire picture", picture_type: "inspiration", url: "https://res.cloudinary.com/favapps-dx-33/image/upload/v1560957108/inspire_malm3_kvhsgq.png", product_id: 1)
ProductPicture.create!(id: 8, name: "Inspire picture", picture_type: "inspiration", url: "https://res.cloudinary.com/favapps-dx-33/image/upload/v1561458539/inspire/inspire_malm17_u6ss5i.jpg", product_id: 1)
...
ProductPicture.create!(id: 34, name: "Inspire picture", picture_type: "inspiration", url: "https://res.cloudinary.com/favapps-dx-33/image/upload/v1560957108/inspire_malm8_ozhoot.png", product_id: 1)
ProductPicture.create!(id: 35, name: "Inspire picture", picture_type: "inspiration", url: "https://res.cloudinary.com/favapps-dx-33/image/upload/v1560957109/inspire_malm9_cwbicj.png", product_id: 1)
