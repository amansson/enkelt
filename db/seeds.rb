...
Product.create!(id: 6, name: "Hemnes", description: "4-drawer chest, black-brown", article_number: "603.604.62", icon: "icon-url", image: "https://res.cloudinary.com/favapps-dx-33/image/upload/v1560782169/img_hemnes_i8wwge.webp", pdf: "show-pdf", video: "show-video")
...
# Product.create!(id: 16, name: "Malm2", description: "4-drawer chest, black-brown", articinle_number: "603.604.62", icon: "icon-url", image: "image-url", pdf: "show-pdf", video: "show-video")
...
ProductPicture.create!(id: 1, name: "Inspire picture", picture_type: "inspiration", url: "https://res.cloudinary.com/favapps-dx-33/image/upload/v1560872530/inspirational6_q7yqkt.jpg", product_id: 2)
ProductPicture.create!(id: 2, name: "Inspire picture", picture_type: "inspiration", url: "https://res.cloudinary.com/favapps-dx-33/image/upload/v1560872530/inspirational4_pzrcyf.jpg", product_id: 2)
